return {
  ...
  config = function()
    ...
    local root_dir = vim.fs.dirname(vim.fs.find({ '.git' }, { upward = true })[1]) or vim.fs.dirname(vim.fs.find({ '.git' }, { downward = true })[1])
    ...
    dashboard.section.buttons.val = {
      ...
      button('p', icons.git.repo .. ' Find project', "<cmd>lua require('telescope').extensions.project.project()<cr>"),
